...
public class lamda {
    ...
    public static void main(String[] args) {
        ...
        //TODO lamda的表达式必须能够符合接口中定义的抽象方法,从参数,到返回值,到异常,都必须匹配

        //TODO lamda 完整版(参数)->｛代码块｝
        ...
        myList.forEach(lamda::processString);

        //TODO lambda 方法引用终极简化版，不是静态方法用引用也可以
        lamda lamda1 = new lamda();
        myList.forEach(lamda1::processStringInst);
        ...
        //TODO 省略也没问题
        myMap.forEach(lamda::processTwoStrings);
    }
